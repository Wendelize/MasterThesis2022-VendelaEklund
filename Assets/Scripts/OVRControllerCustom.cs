...
public class OVRControllerCustom : PortalTraveller
{
	/// <summary>
	...
	void Start()
	{
		...
		smoothYaw = buttonRotation;
		previousOffsetFromPortal = null;
	}
	...
	void Update()
	{
		...
		// Rotate headset with mouse
		float mX = Input.GetAxisRaw("Mouse X");
		buttonRotation += mX * 10;
		buttonRotation = Mathf.SmoothDampAngle(smoothYaw, buttonRotation, ref yawSmoothV, rotationSmoothTime); ;
